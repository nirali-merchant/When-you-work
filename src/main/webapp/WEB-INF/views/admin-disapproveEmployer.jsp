...
<body>
	<c:choose>
		<c:when test="${fn:length(approvedEmployers) gt 0}">
			<table border="1">
				<tr>
					<th>Employer</th>
				</tr>
				<c:forEach var="employer" items="${approvedEmployers}">
					<tr data-employerid=${employer.employerID}>
						<td>${employer.companyName}</td>
						<td><span class="approve">Disapprove this Employer</span></td>
						<td><span class="details">View Details</span></td>
						<input type="hidden" value="${employer.employerID}"
							name="hiddenEmployerID">
					</tr>
				</c:forEach>
			</table>
 ...
 <p> <a href = "${contextPath}/user/logout.htm">Logout</a></p>
</body>
