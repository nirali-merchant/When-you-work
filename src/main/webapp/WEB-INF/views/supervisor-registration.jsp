...
<body>
	<form:form commandName="supervisorstaff" method="post"
		...
		<table>
			<tr>
				<td>First Name:</td>
				<td><form:input path="firstName" pattern ="[A-Za-z]*" /><font color="red"><form:errors
							path="firstName" /></font><br /></td>
			</tr>


			<tr>
				<td>Last Name:</td>
				<td><form:input path="lastName"  pattern ="[A-Za-z]*"/><font color="red"><form:errors
							path="lastName" /></font><br /></td>
			</tr>
			...
			<tr>
				...
				<td><form:select path="employer.companyName">
						...
						<c:forEach var="emp" items="${employers}">
							...
							path="employer.companyName" /></font><br /></td>
			</tr>
